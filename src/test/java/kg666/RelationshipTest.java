...
public class RelationshipTest {
    ...
    public void FindRelationshipsTest(){
        ...
        myNeo4jDriver.executeCypher(String.format("match (n) where n.pic_name is null and n.uid is null set n.pic_name='%s' set n.uid=%s", "tempp", 0));
        ...
        System.out.println("----------------------------------------");
        RelationshipFindVO linkF0 = new RelationshipFindVO("temp", 0L,"66", null, null);
        RelationshipFindVO linkF1 = new RelationshipFindVO("temp", 0L,null, "0", null);
        RelationshipFindVO linkF2 = new RelationshipFindVO("temp", 0L,null, null, "hj2");
        RelationshipFindVO linkF3 = new RelationshipFindVO("temp", 0L,null, "hjm", "hj2");
        RelationshipFindVO linkF4 = new RelationshipFindVO("temp", 0L,"77", "hjm", "hj2");
