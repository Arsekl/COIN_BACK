...
values (0, 'test', 0, 0.0, 1.0, 'red', 'square', false, 12.5, true);
...
values (0, 'test', 0, 'red', 0.5, 'solid', 0.5, true, 12.5, false);
...
values ('temp', 0, 102.36, 29.71, 1, 'red', 'blue', 1, 'solid', 0.5, false, 12, false);